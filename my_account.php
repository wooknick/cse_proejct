...
if($account_exist){
	while($row = $result->fetch_object()){
		...
		echo "<a href='my_account.php?account_no=$account_no_a&account_name=$account_name_a'> $account_name_a </a>";
	}
}
?>	
					</div>
			...
			<div id="common_content">
				...
				<div id="my_account_content">
					<iframe id="my_account_iframe" src="./get_account_state.php?account_no=<?php echo $account_no; ?>&account_name=<?php echo $account_name; ?>" scrolling="yes"></iframe>
				</div>
				<br>
<?php
...
?>
				<div class="common_line">
					...
					<div class="right">
						<div class="my_account_name"> 주식가치 </div>
						<div class="my_account_value"> <span id="total_value">0</span> 원 </div>
						<br>
						<div class="my_account_name"> 현금 </div>
						<div class="my_account_value"> <?php echo number_format($account_balance);?> 원 </div>
					</div>
				</div>
			</div>
			<div id="common_blank">
