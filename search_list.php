...
?>	
			...
			<div id="common_content">
				...
				<div id="my_account_content">
					<iframe id="my_account_iframe" src="./get_search_list.php?search=<?php echo $search; ?>&account_no=<?php echo $account_no; ?>&account_name=<?php echo $account_name; ?>" scrolling="yes"></iframe>
				</div>
				<br>
				<div class="common_line">
				</div>
